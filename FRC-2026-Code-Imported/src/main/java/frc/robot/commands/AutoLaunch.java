...
public class AutoLaunch extends Command {
    ...
    public AutoLaunch(Launcher launcherSubsystem) {
        this(launcherSubsystem, VisionConstants.kPrimaryLimelightName);
    }

    public AutoLaunch(Launcher launcherSubsystem, String limelightName) {
   ...
   // }
    ...
    private double computeShooterPower() {
        if (!LimelightHelpers.getTV(limelightName)) {
            SmartDashboard.putNumber("AutoLaunch/DistanceM", -1);
            SmartDashboard.putBoolean("AutoLaunch/HasTarget", false);
        ...
        SmartDashboard.putNumber("AutoLaunch/DistanceM", distanceMeters);
        SmartDashboard.putBoolean("AutoLaunch/HasTarget", true);
